...
/// 4.7 / 4.8 同 1M（注意：Kiro 内部 4.8 使用横线格式 `claude-opus-4-8`）
...
mod tests {
    ...
    fn test_map_model_opus_4_7() {
        // opus 4-7 映射到 claude-opus-4.7
        let result = map_model("claude-opus-4-7-20260504");
    ...
    #[test]
    fn test_map_model_opus_4_7_dot_notation() {
        // opus 4.7 点号写法映射到 claude-opus-4.7
    ...
    fn test_map_model_opus_4_8() {
        // opus 4-8 映射到 claude-opus-4-8（注意：Kiro 内部 4.8 使用横线格式）
        let result = map_model("claude-opus-4-8-20260605");
    ...
    #[test]
    fn test_map_model_opus_4_8_dot_notation() {
        // opus 4.8 点号写法仍映射到 claude-opus-4-8
